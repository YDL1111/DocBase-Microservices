...
class KnowledgeEvent(BaseModel):
    ...
    visibility: Optional[int] = Field(None, alias="visibility")
    document_created_at: Optional[str] = Field(None, alias="documentCreatedAt")
    document_updated_at: Optional[str] = Field(None, alias="documentUpdatedAt")
