...
-- Nacos 3.1.1 official MySQL schema:
...
CREATE TABLE `group_capacity` (
  ...
  `max_aggr_size` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '聚合配置大小上限',
...
VALUES
  ('1', 'docbase-dev', 'docbase-dev', 'DocBase development namespace', 'bootstrap',
