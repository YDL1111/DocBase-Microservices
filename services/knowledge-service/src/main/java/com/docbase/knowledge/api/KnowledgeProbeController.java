package com.docbase.knowledge.api;
...
public class KnowledgeProbeController {
    private final String applicationName;

    public KnowledgeProbeController(@Value("${spring.application.name}") String applicationName) {
