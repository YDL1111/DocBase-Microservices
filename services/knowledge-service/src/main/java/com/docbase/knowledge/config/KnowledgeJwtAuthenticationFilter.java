...
/**
 * JWT authentication filter for knowledge-service.
 * Extracts user identity from the JWT access token, checks auth_version,
 * and builds a KnowledgeUserPrincipal.
 */
public class KnowledgeJwtAuthenticationFilter {

    private static final Logger log = LoggerFactory.getLogger(KnowledgeJwtAuthenticationFilter.class);

    private final JwtVerifier jwtVerifier;
    private final AuthVersionChecker authVersionChecker;

    public KnowledgeJwtAuthenticationFilter(JwtVerifier jwtVerifier, AuthVersionChecker authVersionChecker) {
